...
byte inchora = 20;  // autoclose hours
byte inchmin = 46;  // autocloese minutes
byte deschora = 20; // autoopen hours
byte deschmin = 47; // autopen minutes
...
lcd.print("ver.5d by niq_ro"); // afisare text
